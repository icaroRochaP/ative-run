...
INSERT INTO onboarding_questions (step_number, question_type, title, subtitle, emoji, icon, field_name, placeholder, required, options, validation) VALUES
(0, 'text', 'Nice to meet you!', 'How would you like to be addressed?', NULL, 'User', 'name', 'Enter your name...', TRUE, NULL, '{"minLength": 2}'),

(1, 'number', 'What''s your age?', 'This helps us personalize your fitness plan', '🎂', NULL, 'age', '25', TRUE, NULL, '{"min": 13, "max": 100}'),

(2, 'email', 'Your email address', 'For account recovery and important updates', '📧', NULL, 'email', 'your@email.com', TRUE, NULL, '{"pattern": "email"}'),

(3, 'radio', 'Which gender do you identify with?', 'This helps us provide better recommendations', '👤', NULL, 'gender', NULL, TRUE, '["Female", "Male", "Other / Prefer not to say"]', NULL),

(4, 'text', 'What''s your current weight?', 'Please specify in kg or lbs (e.g., "65 kg" or "145 lbs")', '⚖️', NULL, 'weight', '65 kg or 145 lbs', TRUE, NULL, NULL),

(5, 'text', 'What''s your current height?', 'Please specify in cm or feet/inches (e.g., "170 cm" or "5''7")', '📏', NULL, 'height', '170 cm or 5''7"', TRUE, NULL, NULL),

(6, 'radio', 'What''s your primary goal?', 'Be specific about what you want to achieve', NULL, 'Target', 'primaryGoal', NULL, TRUE, '["Fat Loss", "Muscle Gain", "Toning", "Health and Energy", "Other (specify)"]', NULL),

...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || "https://fkbfszbbwjwdclxpnhdv.supabase.co"
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZrYmZzemJid2p3ZGNseHBuaGR2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTIzMTk4MzQsImV4cCI6MjA2Nzg5NTgzNH0.yQX_GHh8vl8qJY7q_5Qe9JYwO-QSGxjD_5h1gw8G0dE"

...
import { Loader2, MapPin, Clock, Zap, Heart, Activity, RefreshCw } from 'lucide-react'
          ...
          <>
            <div className="space-y-3">
              {activities.map((activity) => (
                <ActivityCard key={activity.id} activity={activity} onActivityClick={onActivityClick} />
              ))}
            </div>
...
function ActivityCard({ activity, onActivityClick }: { activity: any; onActivityClick?: (activity: any) => void }) {
  ...
  return (
    <div 
      className={cn(
        ...
        onActivityClick ? "hover:bg-gray-50 cursor-pointer" : "hover:bg-gray-50"
      )}
